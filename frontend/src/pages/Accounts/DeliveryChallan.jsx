...
const DeliveryChallanManagement = () => {
  ...
  const {
    controlledRows: visibleChallans,
    searchTerm,
    setSearchTerm,
    requestSort,
    sortLabel,
  } = useTableControls(challans, CHALLAN_SEARCH_FIELDS, { key: 'challan_date', accessor: 'challan_date', direction: 'desc' });
            ...
            <fieldset className="quotation-field-group" id="quotation-details-fieldset">
              ...
              <div className="quotation-input-group" id="payment-info-group">
                ...
                <input
                  ...
                  style={{ backgroundColor: 'var(--theme-surface-muted,#f5f5f5)', cursor: 'not-allowed', width: '100%' }}
                />
              ...
              <div className="quotation-form-grid-two" id="address-grid">
                ...
                <div className="quotation-input-group" id="from-address-group">
                  ...
                  <textarea
                    ...
                    rows="3"
                    style={{ backgroundColor: 'var(--theme-surface-muted,#f5f5f5)', cursor: 'not-allowed' }}
                  />
            ...
            <div className="quotation-history-content" id="quotation-history-content">
              ...
              <div className="quotation-table-container" id="history-table-container">
                <table className="quotation-history-table" id="quotation-history-table">
                  <thead>
                    <tr>
                      <th className="sortable-th" onClick={() => requestSort('id', 'id')}>Challan ID{sortLabel('id')}</th>
                      <th className="sortable-th" onClick={() => requestSort('challan_no', 'challan_no')}>Challan No{sortLabel('challan_no')}</th>
                      <th className="sortable-th" onClick={() => requestSort('challan_date', 'challan_date')}>Challan Date{sortLabel('challan_date')}</th>
                      <th className="sortable-th" onClick={() => requestSort('destination', 'destination')}>Destination{sortLabel('destination')}</th>
                      <th className="sortable-th" onClick={() => requestSort('dispatched_through', 'dispatched_through')}>Dispatch Method{sortLabel('dispatched_through')}</th>
                      <th>Actions</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              {visibleChallans.length === 0 && (
                <div className="quotation-empty-state" id="empty-quotation-state">
                  ...
                  <p className="quotation-empty-subtext">
                    {searchTerm ? 'Try changing your search to see more results.' : 'Get started by creating your first delivery challan.'}
                  </p>
                </div>
              )}
            </div>
                ...
                <div className="quotation-form-grid-two" id="address-details-grid">
                  <div className="quotation-detail-item" id="to-address-item">
                    ...
                    <div style={{
                      whiteSpace: 'pre-line',
                      padding: '8px',
                      backgroundColor: 'var(--theme-bg-muted,#f8f9fa)',
                      borderRadius: '4px',
