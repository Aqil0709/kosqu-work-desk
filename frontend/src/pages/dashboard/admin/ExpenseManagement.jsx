...
const ExpenseManagement = () => {
  ...
  const getPaymentBadge = (paymentStatus) => {
    ...
    const paymentColors = {
      pending: { background: 'rgba(245,158,11,0.12)', color: '#d97706', icon: '⏳' },
      paid: { background: 'rgba(16,185,129,0.12)', color: '#059669', icon: '✅' },
      cancelled: { background: 'rgba(220,38,38,0.12)', color: '#dc2626', icon: '❌' }
    };
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              <thead>
                <tr style={{ borderBottom: '2px solid var(--card-border,#e2e8f0)', background: 'var(--theme-bg-muted,#f9fafb)' }}>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Employee</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Category</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Amount</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Description</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Receipt</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Payment Status</th>
                  <th style={{ padding: '1rem', textAlign: 'left', fontWeight: '600', color: 'var(--theme-text,#4a5568)' }}>Date</th>
                ...
                {expenses.map((expense, index) => (
                  <tr key={expense.id || index} style={{ borderBottom: '1px solid var(--card-border,#e2e8f0)' }}>
                    <td style={{ padding: '1rem' }}>
                      <div>
                        <div style={{ fontWeight: '500', color: 'var(--theme-text-strong,#2d3748)' }}>
                          {expense.first_name || 'Unknown'} {expense.last_name || ''}
                        </div>
                        <div style={{ fontSize: '0.875rem', color: 'var(--theme-text,#718096)' }}>
