...
const ClientsManagement = () => {
  ...
  const handleEditClient = (client) => {
    ...
    setEditFormData({
      ...
      gst_type: client.gst_type || 'Unregistered',
      ...
      <div className="client-table-container glass-form-client">
        ...
        {clients.length === 0 && (
          <div className="client-no-data">
            <div className="client-no-data-icon"><i className="fa-solid fa-people-line"></i></div>
          ...
          <div className="client-modal-content">
            ...
            <form onSubmit={handleSubmit} className="client-form">
              <div className="client-form-section">
                ...
                <h3 className="client-section-title" style={{ marginTop: 16 }}>GST & Billing</h3>
                <div className="client-form-row">
                  <div className="client-form-group">
                    <label className="client-form-label">GST Number</label>
                    <input
                      type="text"
                      name="gst_number"
                  ...
                  <div className="client-form-group">
                    <label className="client-form-label">GST Type</label>
                    <select name="gst_type" value={formData.gst_type} onChange={handleInputChange} className="client-form-select">
                ...
                <div className="client-form-group">
                  <label className="client-form-label">Billing Address</label>
                  <textarea
                ...
                <h3 className="client-section-title" style={{ marginTop: 16 }}>Contract Details</h3>
                <div className="client-form-row">
                  <div className="client-form-group">
                  ...
                  <div className="client-form-group">
                    <label className="client-form-label">Website</label>
                    <input
                      type="url"
                      name="website"
                ...
                <div className="client-form-row">
                  <div className="client-form-group">
                    <label className="client-form-label">Contract Start Date</label>
                    <input
                      type="date"
                  ...
                  <div className="client-form-group">
                    <label className="client-form-label">Contract End Date</label>
                    <input
                      type="date"
                ...
                <div className="client-form-group">
                  <label className="client-form-label">Notes</label>
                  <textarea
                    name="notes"
        ...
        <div className="client-modal-overlay">
          <div className="client-modal-content client-large-modal">
            ...
            <div className="client-details-content">
              ...
              {/* GST & Billing */}
              {(selectedClient.gst_number || selectedClient.billing_address) && (
                <div className="client-form-section">
                  <h3 className="client-section-title">GST & Billing</h3>
                  <div className="client-details-grid">
                    {selectedClient.gst_number && (
                      <div className="client-detail-item">
                        <label className="client-detail-label">GST Number</label>
                        <span className="client-detail-value">{selectedClient.gst_number}</span>
                      </div>
                    )}
                    <div className="client-detail-item">
                      <label className="client-detail-label">GST Type</label>
                      <span className="client-detail-value">{selectedClient.gst_type || 'Unregistered'}</span>
                    </div>
                    {selectedClient.billing_address && (
                      <div className="client-detail-item">
                        <label className="client-detail-label">Billing Address</label>
                        <span className="client-detail-value">{selectedClient.billing_address}</span>
                      </div>
                    )}
                  </div>
                </div>
              ...
              {/* Contract Details */}
              {(selectedClient.pan_number || selectedClient.website || selectedClient.contract_start_date || selectedClient.contract_end_date) && (
                <div className="client-form-section">
                  <h3 className="client-section-title">Contract Details</h3>
                  <div className="client-details-grid">
                    {selectedClient.pan_number && (
                      <div className="client-detail-item">
                        <label className="client-detail-label">PAN Number</label>
                        <span className="client-detail-value">{selectedClient.pan_number}</span>
                      </div>
                    )}
                    {selectedClient.website && (
                      <div className="client-detail-item">
                        ...
                        <span className="client-detail-value">
                          <a href={selectedClient.website} target="_blank" rel="noopener noreferrer">{selectedClient.website}</a>
                        </span>
                      </div>
                    )}
                    {selectedClient.contract_start_date && (
                      <div className="client-detail-item">
                        <label className="client-detail-label">Contract Start</label>
                        <span className="client-detail-value">{selectedClient.contract_start_date?.split('T')[0]}</span>
                      </div>
                    )}
                    {selectedClient.contract_end_date && (
                      <div className="client-detail-item">
                        <label className="client-detail-label">Contract End</label>
                        <span className="client-detail-value">{selectedClient.contract_end_date?.split('T')[0]}</span>
                      </div>
                    )}
                  </div>
                </div>
            ...
            <form onSubmit={handleUpdateClient} className="client-form">
              <div className="client-form-section">
                ...
                <div className="client-form-row">
                  ...
                  <div className="client-form-group">
                    <label className="client-form-label">GST Type</label>
                    <select name="gst_type" value={editFormData.gst_type} onChange={handleEditInputChange} className="client-form-select">
                      <option value="Unregistered">Unregistered</option>
                      <option value="Regular">Regular</option>
                      <option value="Composition">Composition</option>
                      <option value="SEZ">SEZ</option>
