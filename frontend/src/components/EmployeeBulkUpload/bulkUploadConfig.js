...
export const BULK_UPLOAD_COLUMNS = [
  ...
  { key: 'email',         label: 'Email',              required: false, aliases: ['email address', 'email_address'] },
  ...
  // ── Employment ────────────────────────────────────────────────────────────────
  { key: 'position',             label: 'Designation',          required: false, aliases: ['designation', 'job title', 'job_title'] },
  { key: 'department',           label: 'Department',           required: false, aliases: ['department name', 'department_name'] },
  { key: 'department_id',        label: 'Department ID',        required: false, aliases: ['department id', 'department_id'] },
  { key: 'employment_type',      label: 'Employment Type',      required: false, aliases: ['employment type', 'employment_type', 'employee type'] },
  ...
  { key: 'joining_date',         label: 'Joining Date',         required: false, aliases: ['date of joining', 'date_of_joining', 'joining_date'] },
